...
деталь*. В данном случае процесс &mdash; это «Производство
автомобиля». Если задание не выполнено, то возможно альтернативное
задание в рамках процесса, например, *«Купить на али эту деталь»*.
